...
class _TagSelectionBoxState extends State<TagSelectionBox> {
  ...
  Set<Tag> userTags = {};
  Set<Tag> entryTags = {};
  late int selectedColor = widget.themeData.colorScheme.primary.toARGB32();
                      ...
                      Row(
                        children: [
                          ...
                          IconButton(
                            ...
                            onPressed: () async {
                              int newsSelectedColor = await showColorPicker(context, widget.themeData);
                              setState(() {
  ...
  Future<int> showColorPicker(BuildContext context, ThemeData themeData) async {
    int currentColor = widget.themeData.colorScheme.primary.toARGB32();
          ...
          child: AlertDialog(
            ...
            content: SingleChildScrollView(
              child: ColorPicker(
                ...
                pickerColor: themeData.colorScheme.primary,
                labelTypes: [],
